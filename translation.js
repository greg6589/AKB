...
let data = {
    'polish': {
        ...
        'consultingDes': 'Po zgłoszeniu się do nas pomożemy skonfrontować Państwa oczekiwania z aktualną sytuacją na rynku aut używanych. Doradzimy również czy poszukiwany przez Państwa samochód to możliwie najlepszy wybór wśród dostępnych marek i modeli.',
        'more': 'więcej2',
        'consultingDesMore': 'Wybór odpowiedniego modelu samochodu dopasowanego do potrzeb i oczekiwań klienta to bardzo ważna kwestia. Dzięki temu unikniemy rozczarowań w warsztacie, irytacji podczas parkowania w centrum miasta lub zaskoczenia podczas tankowania. Kwestia wyposażenia samochodu nie powinna być również obojętna ponieważ to od niej zależy nasz komfort podróżowania nowym samochodem.',
        'searchTitle': 'Znalezienie auta',
        'searchDes': 'Po ustaleniu jakiego modelu mamy dla Państwa szukać zaczynamy proces poszukiwania wybranego samochodu. Na tym etapie mogą Państwo zrezygnować z osobistego przeglądania ofert, lecz dalsze uczestniczenie w tym procesie jest również możliwe.',
        'searchDesMore': 'Po znalezieniu interesującej oferty lub otrzymaniu jej od Państwa dokonamy wstępnej weryfikacji i rozmowy ze sprzedającym celem uzyskania jak najwięcej informacji o danym egzemplarzu. Następnie konsultujemy z Państwem czy ten egzemplarz na pewno spełnia Państwa oczekiwania, jeśli odpowiedź jest pozytywna przechodzimy do etapu weryfikacji.',
        ...
        'moneyDesMore': 'Dzięki nam oszczędzają Państwo wiele czasu na przeglądaniu ofert i oglądaniu aut które na miejscu okazują się mocno odbiegać stanem od tych ze zdjęć sprzedawcy. Nasze doświadczenie w branży motoryzacyjnej i znajomość rynku oszczędzi Państwu również nerwów związanych z kontaktem ze sprzedającym a ostatecznie kupienie sprawdzonego przez nas auta uchroni przed niechcianymi wydatkami.',
